package com.service.backend.bookshop.security.controller;
...
import static com.service.backend.bookshop.common.entity.security.Role.ROLE_ADMIN;


@Tag(name = "User-Security", description = "signing and signup for bookshop website.")
@RestController
